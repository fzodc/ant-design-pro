export default {
  ...
  'form.tenant.placeholder': '租户名',
  'form.address.placeholder': '公司地址',
  'form.description.placeholder': '公司描述',
  ...
  'form.goal.placeholder': 'please enter你的阶段性工作目标',
  'form.standard.label': '衡量标准',
  'form.standard.placeholder': 'please enter衡量标准',
  ...
  'form.weight.placeholder': 'please enter',
