export default {
  ...
  'menu.admin': '维护',
  'menu.admin.logPage': 'UI日志',
  'menu.admin.apiLogList': 'Api日志',
  ...
  'menu.apiGateway.apiDocUpdate': '编写Api文档',
  'menu.apiGateway.wsdlList': 'Wsdl管理',
  'menu.apiGateway.adapterSpec': '适配器配置',
  'menu.apiGateway.attrSpec': '属性规格',
